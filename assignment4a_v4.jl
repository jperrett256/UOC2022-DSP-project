...
let
	...
	# TODO calculate max and min possible values of fh, and use that range instead to set lags
	# TODO do the same for fv (don't have to do the whole thing!)
	# flatten with gaussian and take maximum?
